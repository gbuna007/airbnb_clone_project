...
sarina = User.create(email: "sarina.y.ke@gmail.com", password: "sarina123")
laura = User.create(email: "laura.kim@gmail.com", password: "laura123")
anushka = User.create(email: "anushka.p@gmail.com", password: "anushka123")
